...
public class TreeSetEx2 {
    public static void main(String[] args) {
        ...
        // method first - vivodit 1 element spiska
        System.out.println(treeSet.first());
        // method last - vivodit posledniy element spiska
        System.out.println(treeSet.last());
//        // method headSet - vivodit elementi < klycha st6
//        Student st6 = new Student("Oleg", 3);
//        System.out.println(treeSet.headSet(st6));
//        // method headSet - vivodit elementi >= klycha st6
//        System.out.println(treeSet.tailSet(st6));
        //method subSet - vivodit elementi >=st6 no <st7
